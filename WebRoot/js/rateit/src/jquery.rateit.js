    ...
    $.fn.rateit = function (p1, p2) {
        ...
        return this.each(function () {
            ...
            if (!itemdata('init')) {
                ...
                item.append('<div class="rateit-range" style="top:3px;"><div class="rateit-selected" style="height: 16px"></div><div class="rateit-hover" style="height:' + itemdata('starheight') + 'px"></div></div><a class="rateit-reset" style="margin-left:10px; color: #37A;text-decoration: none;cursor: pointer;">删除</a>');
